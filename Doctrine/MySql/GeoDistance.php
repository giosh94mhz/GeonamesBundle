...
class GeoDistance extends FunctionNode
{
    ...
    {
        /*
         * Giving each argument only once and using %1$s, %2$s, ... doesn't work.
         * Would result in: SQLSTATE[HY093]: Invalid parameter number: number of bound variables does not match number of tokens
         *
